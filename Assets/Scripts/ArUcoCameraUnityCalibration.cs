...
public class ArUcoCameraUnityCalibration : MonoBehaviour
{
    /// <summary>
    ...
    public NumberOfBoardSizeWidth boardSizeW = NumberOfBoardSizeWidth.W_8;
    ...
    public NumberOfBoardSizeHeight boardSizeH = NumberOfBoardSizeHeight.H_8;
    ...
    void OnReadbackComplete(AsyncGPUReadbackRequest request)
    {
        ...
        if (texture == null)
        {
            Debug.LogWarning("Texture been destroyed");
            return;
        }

        NativeArray<byte> data = request.GetData<byte>();
        ProcessReadbackData(data);
    }
    void ProcessReadbackData(NativeArray<byte> data)
    {
        ...
        Utils.RawTextureDataToMat(data, rgbaMat, rgbaMat.width(), rgbaMat.height());
    ...
    {
        Mat frameMat = new Mat(imgTexture.height, imgTexture.width, CvType.CV_8UC4);
